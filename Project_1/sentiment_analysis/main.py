...
best_accuracy = p1.accuracy(p1.classify(test_bow_features, best_theta, best_theta_0),
                            test_labels)
...
#    - try to count words rather than indicating its appearance
#-------------------------------------------------------------------------------


with open('stopwords.txt', 'r') as file:
    dictionary = p1.bag_of_words(train_texts, stop_words=file.read().split('\n'))
...
best_accuracy = p1.accuracy(p1.classify(test_bow_features, theta, theta_0),
                            test_labels)

print('Try to remove stop words:')
print('Accuracy on the test set: {:.4f}'.format(best_accuracy))
